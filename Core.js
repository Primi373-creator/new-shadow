...
let banUser = JSON.parse(fs.readFileSync('./Assets/database/banUser.json'));
let banchat = JSON.parse(fs.readFileSync('./Assets/database/banChat.json'));
let Cipheraudio = JSON.parse(fs.readFileSync('./Assets/Media-Database/audio.json'));
let _limit = JSON.parse(fs.readFileSync('./Assets/storage/user/limit.json'));
let _buruan = JSON.parse(fs.readFileSync('./Assets/storage/user/bounty.json'));
let _darahOrg = JSON.parse(fs.readFileSync('./Assets/storage/user/blood.json'))
let ntnsfw = JSON.parse(fs.readFileSync('./Assets/database/nsfw.json')); //
let pendaftar = JSON.parse(fs.readFileSync('./Assets/storage/user/user.json'))
let balance = JSON.parse(fs.readFileSync('./Assets/database/balance.json'))
let ssewa = JSON.parse(fs.readFileSync('./Assets/database/sewa.json'))
let ban = JSON.parse(fs.readFileSync('./Assets/database/ban.json'))
let autosticker = JSON.parse(fs.readFileSync('./Assets/database/autosticker.json'))
const _autostick = JSON.parse(fs.readFileSync('./Assets/database/autostickpc.json'))
let limit = JSON.parse(fs.readFileSync('./Assets/database/limit.json'))
...
const sewa = JSON.parse(fs.readFileSync('./Assets/database/sewa.json'))
...
module.exports = shadow = async (shadow, m, chatUpdate, store) => {
  try {
    ...
    if (isCmd && !isUser) {
      ...
      fs.writeFileSync("./Assets/storage/user/user.json", JSON.stringify(pendaftar));
    }
...
Typed *surrender* to surrender and admited defeat`
    ...
    const responses = {
      ...
      hello: `Konichiwa ${pushname} Senpai!!, I am ${BotName}.\nMy current prefix is "${prefix}".\nHow can I help you?`,
      Cipher: `🌑 I am alive, lurking in the shadows. Can you feel my presence?`,
      runtime: `konichiwa ${pushname} senpai!!\n${nowtime}\n\nMy runtime:${runtime(process.uptime())}\n`,
      konichiwa: `Konichiwa ${pushname}, I am ${BotName}. How can I help you?`,
      sasha: 'Only you...🫶🏻',
      ping: `Konnichiwa ${pushname} senpai!!\n Pong ${latensie.toFixed(4)} ms`,
      'good morning': `Ohayou gozaimasu 🌅 ${pushname} senpai!! ☺️. Have a great day 😇.`,
      ohayo: `Ohayou gozaimasu 🌅 ${pushname} senpai!! ☺️. Have a great day 😇.`,
      'good afternoon': `Konnichiwa ${pushname} senpai 🏞!. Wishing you an enjoyable afternoon too 😇🤞🏻.`,
      konnichiwa: `Konnichiwa ${pushname} senpai 🏞!. Wishing you an enjoyable afternoon too 😇🤞🏻.`,
      'good night': `Oyasumi nasai 🌌 ${pushname} senpai!! 😇. Sleep well and sweet dreams.`,
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'sourcecode': {
        ...
        teks = `*shadow Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Cipher0071/SHADOW-MD\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
        /*  let buttons = [
      ...
      case 'support': case 'supportgc': {
        ...
        shadow.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(`⚙ *My developer's group:* https://chat.whatsapp.com/FCfSLTySyqz1c7YPJD2KSm`)
      }
        break;
      ...
      case 'repo': case 'botrepo': {
        ...
        shadow.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(`⚙ My Source Code is </> - https://github.com/Cipher0071/SHADOW-MD`)
      }
        break;
      ...
      case 'addowner':
        ...
        Owner.push(bnnd)
        fs.writeFileSync('./Assets/database/mod.json', JSON.stringify(Owner))
      ...
      case 'modlist':
        ...
        try {
          const modData = fs.readFileSync('./Assets/database/mod.json', 'utf8');
...
//====================================================================================================================//
      ...
      case 'nsfwmenu':
        ...
        reply(` *╭═══〘 ⚠️ NSFW Menu ⚠️ 〙═══⊷❍*\n\n gifs, hentaivideo, blowjobgif, hneko, masturbation, thighs, pussy, panties, orgy, ahegao, ass, bdsm, blowjob, cuckold, ero, gasm, cum, femdom, foot, gangbang, glasses, jahy, trap, spank, hneko, hwaifu, gasm`)
        break;
      ...
      case 'ahegao':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/agegao.json'))
      ...
      case 'ass':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/ass.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'bdsm':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/bdsm.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'blowjob':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/blowjob.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'cuckold':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/cuckold.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'cum':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/cum.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'eba':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/eba.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'ero':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/ero.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'femdom':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/femdom.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'foot':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/foot.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'gangbang':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/gangbang.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'gifs':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/gifs.json'))
      ...
      case 'glasses':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/glasses.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'hentai':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/hentai.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'jahy':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/pussy.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'mangansfw':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/manga.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'masturbation':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/masturbation.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'milf':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/milf.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'neko':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/neko.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'neko2':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/neko2.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'nsfwloli':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/nsfwloli.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'orgy':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/orgy.json'));
      ...
      case 'panties':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/panties.json'));
        var numberOfPictures = 3; // Change this value if you want to send a different number of pictures
      ...
      case 'tentacles':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/tentacles.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
      ...
      case 'thighs':
        ...
        var nsfwdata = JSON.parse(fs.readFileSync('./Assets/HostMedia/nsfw/thighs.json'))
        var Cipherresult = pickRandom(nsfwdata)
        shadow.sendMessage(m.chat, { caption: mess.success, image: { url: Cipherresult.url } }, { quoted: m })
        break;
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'leveling':
        ...
        if (args[0] === 'on') {
          ...
          _leveling.push(from)
          fs.writeFileSync('./Assets/database/leveling.json', JSON.stringify(_leveling))
        ...
        if (isCreator) {
          ...
          shadow.query({
            ...
            if (sizny < 20) {
              ...
              sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/images/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "916297175943@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
            } else if (sizny > 20) {
              await shadow.groupAcceptInvite(vcc).then(async (res) => reply(jsonformat(res))).catch(_ => _)
              reply("Joined !")
            } else {
...
//============================================================================================//
       ...
       case 'leavegc': case 'leavegroup': case 'exitgc': {
         if (isBan) return reply(mess.banned);	 			
         if (isBanChat) return reply(mess.bangc);
         if (!m.isGroup) return reply(mess.grouponly);
             reply(mess.waiting)
      ...
      case 'apod': {
        ...
        const timeZone = 'Africa/lagos'; // Set desired timezone.
